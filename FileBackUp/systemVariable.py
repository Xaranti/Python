...
def systemVar(driver,planName,systemVariable):
    ...
    driver.find_element(By.XPATH,"//h4[text()='System variable']").click()
    driver.find_element(By.CSS_SELECTOR,"input[formcontrolname='systemVariable']").send_keys(systemVariable)
    driver.find_element(By.XPATH,"//*[contains(text(),'Apply')]").click()
