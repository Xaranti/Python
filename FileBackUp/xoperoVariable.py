...
def xoperoVar(driver,planName,xoperoVariable):
    ...
    driver.find_element(By.CSS_SELECTOR, "ng-select[bindlabel='name']").click()
    driver.find_element(By.XPATH,"//h4[text()='Xopero variable']").click()
    driver.find_element(By.CSS_SELECTOR, "ng-select[formcontrolname='xoperoVariable']").click()
    driver.find_element(By.XPATH,"//h4[text()='%s']" %(xoperoVariable)).click()
    driver.find_element(By.XPATH,"//*[contains(text(),'Apply')]").click()
    ...
    driver.find_element(By.XPATH,"//*[contains(text(),'Tasks')]").click()
